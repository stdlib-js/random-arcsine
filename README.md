...
```javascript
arcsine = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-arcsine@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-arcsine/tags). For example,

```javascript
arcsine = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-arcsine@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var arcsine = require( 'path/to/vendor/umd/random-arcsine/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-arcsine@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-arcsine.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-arcsine

[test-image]: https://github.com/stdlib-js/random-arcsine/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-arcsine/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-arcsine/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-arcsine?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-arcsine.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-arcsine/main
...
[deno-url]: https://github.com/stdlib-js/random-arcsine/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-arcsine/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-arcsine/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-arcsine/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-arcsine/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-arcsine/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-arcsine/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-arcsine/main/LICENSE
